...
function populate_quicklaunch_bar(xmlDoc) {
	...
	if(list) {
		...
		for(var i=0; i<songs.length; i++) {
			...
			var delete_image = "<div class='col-md-1 remove-playlist'><a onclick='remove_song("+song_id+")''><img class='delete_image' src='assets/images/remove.png'></a></div>";
			html += "<li role='presentation'>";
			html += "<div class='col-md-11 play-list-song'role=\"menuitem\" tabindex=\"-1\" ";
